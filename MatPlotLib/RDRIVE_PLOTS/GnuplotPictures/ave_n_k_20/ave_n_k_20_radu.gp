...
plot "ave_n_k_20.dat" using 3:5:xtic(1) title 'k' lw 2 linecolor rgb 'red' fs pattern 1,\
     "ave_n_k_20.dat" using 2:4:xtic(1) title 'n' lw 2 linecolor rgb 'blue'  fs pattern 4,\
