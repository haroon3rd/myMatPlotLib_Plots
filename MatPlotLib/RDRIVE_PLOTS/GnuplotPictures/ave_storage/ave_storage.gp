...
plot "ave_storage.dat" using 2:5:xtic(1) title "NS: 10" lw 2 linecolor rgb 'grey60' fs pattern 4,\
     "ave_storage.dat" using 3:6:xtic(1) title "NS: 20" lw 2 linecolor rgb 'grey50' fs pattern 5,\
     "ave_storage.dat" using 4:7:xtic(1) title "NS: 30" lw 2 linecolor rgb 'grey50' fs pattern 6,\
