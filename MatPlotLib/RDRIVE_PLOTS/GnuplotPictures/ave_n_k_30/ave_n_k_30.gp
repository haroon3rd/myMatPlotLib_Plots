...
plot "ave_n_k_30.dat" using 2:4:xtic(1) title "N" lw 2 linecolor rgb 'grey60' fs pattern 4,\
     "ave_n_k_30.dat" using 3:5:xtic(1)         title "K" lw 2 linecolor rgb 'grey50' fs pattern 5,\
